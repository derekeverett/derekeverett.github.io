...
I am a member of the [JETSCAPE collaboration](jetscape.org), designed to tackle both physical and statistical modeling of heavy-ion collisions. 
...
To understand the properties of this Quark-Gluon Plasma, we develop physics models and compare their predictions to data measured in the labaratory. We use [Bayesian inference](https://en.wikipedia.org/wiki/Bayesian_inference) to disentangle the properties of the collision at early times given the finally measured particles. 
...
I've developed a [freestreaming model](https://github.com/derekeverett/freestream-milne) to solve the expansion in two or three spatial dimensions. More complicated models assume that the particles can interact at early times. I've also developed [KTIso](https://github.com/derekeverett/KTIso) to simulate the expansion of interacting particles. It determinanistically solves the [Boltzmann equation](https://en.wikipedia.org/wiki/Boltzmann_equation).  

A core component of many models is relativistic viscous hydrodynamics. I've assisted in the continued development and maintenance of a [relativistic viscous hydrodynamic code](https://github.com/derekeverett/cpu-vh), additionally with a [version optimized for Graphics Processors](https://github.com/derekeverett/gpu-vh). 
After a phase of hydrodynamic expansion, the fluid cools and breaks apart into hadrons, which finally reach the detector. Our research group developed a [model](https://github.com/derekeverett/iS3D) which simulates this [particlization process](https://arxiv.org/abs/1912.08271). 
